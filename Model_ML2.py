...
# Export optimal costs and capacities
...
df5=pd.DataFrame(capPV_res_d, index=index_years) # add a similar line to export other optimal capacities
df1.index.name = 'Years'
df2.index.name = 'Years'
df3.index.name = 'Years'
df4.index.name = 'Years'
df5.index.name = 'Years'
...
df5.to_excel(writer, sheet_name='PV_cap', float_format="%.13f")
...
df5=pd.DataFrame(capPV_res_c, columns=column_names, index=index_cases) # add a similar line to export other optimal capacities
...
df5.index.name = 'Number of stochastic scenarios'
...
for yi in range(C*4):
    res_el=ax2[0,0].plot(hours, typical_days[yi,:,C-2,Y-2005][72:96], "b", linewidth=1)
    ter_el=ax2[0,1].plot(hours, typical_days[yi,:,C-2,Y-2005][96:120], "b", linewidth=1)
    com_el=ax2[1,0].plot(hours, typical_days[yi,:,C-2,Y-2005][120:144], "b", linewidth=1)
    pub_el=ax2[1,1].plot(hours, typical_days[yi,:,C-2,Y-2005][144:168], "b", linewidth=1)
...
for yi in range(C*4):
    res_th=ax3[0,0].plot(hours, typical_days[yi,:,C-2,Y-2005][168:192], "b", linewidth=1)
    ter_th=ax3[0,1].plot(hours, typical_days[yi,:,C-2,Y-2005][192:216], "b", linewidth=1)
    com_th=ax3[1,0].plot(hours, typical_days[yi,:,C-2,Y-2005][216:240], "b", linewidth=1)
    pub_th=ax3[1,1].plot(hours, typical_days[yi,:,C-2,Y-2005][240:264], "b", linewidth=1)
...
for yi in range(4):
    res_el=ax8[0,0].plot(hours, DemEl_res_av[:,yi,Y-2005], "b", linewidth=1)
    ter_el=ax8[0,1].plot(hours, DemEl_ter_av[:,yi,Y-2005], "b", linewidth=1)
    com_el=ax8[1,0].plot(hours, DemEl_com_av[:,yi,Y-2005], "b", linewidth=1)
    pub_el=ax8[1,1].plot(hours, DemEl_pub_av[:,yi,Y-2005], "b", linewidth=1)
...
for yi in range(4):
    res_th=ax9[0,0].plot(hours, DemTh_res_av[:,yi,Y-2005], "b", linewidth=1)
    ter_th=ax9[0,1].plot(hours, DemTh_ter_av[:,yi,Y-2005], "b", linewidth=1)
    com_th=ax9[1,0].plot(hours, DemTh_com_av[:,yi,Y-2005], "b", linewidth=1)
    pub_th=ax9[1,1].plot(hours, DemTh_pub_av[:,yi,Y-2005], "b", linewidth=1)
